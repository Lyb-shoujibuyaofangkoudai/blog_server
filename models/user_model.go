...
type UserModel struct {
	...
	ArticleModels []ArticleModel   `gorm:"foreignKey:UserID" json:"_"`                                                       // 发布文章列表
	CollectsModel []ArticleModel   `gorm:"many2mant:auth2_collects;joinForeignKey:AuthID;joinReferences:ArticleID" json:"_"` // 收藏文章列表
}
